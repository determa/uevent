...
import evnts from "../components/eventList";
...
const EventPage = () => {
    ...
    return (
        <>
            <Header />
            <div className="flex pt-12 gap-3 px-4 justify-center">
                ...
                <div className="flex flex-col p-3 bg-white border border-gray-200 rounded-lg gap-3 h-fit">
                    <p className="text-sm rounded-lg p-3 text-white bg-[#ED4690]/70">{event.date}</p>
                    <h1 className="text-5xl">{event.name}</h1>
                    <p className="text-sm">{event.place}</p>
                    <p className="text-sm font-bold">{event.price}</p>
                    <button className="bg-purp text-white p-3 rounded-lg">buy</button>
                </div>
            </div>
            <Footer />
        </>
